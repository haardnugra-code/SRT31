      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-5 md:p-6 rounded-xl border border-slate-200 shadow-sm space-y-4 lg:col-span-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
            <div className="bg-red-50/80 p-3.5 sm:p-4 rounded-xl border border-red-200 shadow-sm">
              <span className="block text-2xl sm:text-3xl font-black text-red-600">
                {violations.length}
              </span>
              <span className="text-xs font-bold text-slate-700 mt-1 block">Pelanggaran</span>
              <span className="text-[11px] text-red-700 font-medium">Buku Disiplin</span>
            </div>
            <div className="bg-amber-50/80 p-3.5 sm:p-4 rounded-xl border border-amber-200 shadow-sm">
              <span className="block text-2xl sm:text-3xl font-black text-amber-600">
                {counseling.length}
              </span>
              <span className="text-xs font-bold text-slate-700 mt-1 block">BK / Konseling</span>
              <span className="text-[11px] text-amber-700 font-medium">Bimbingan Siswa</span>
            </div>
            <div className="bg-emerald-50/80 p-3.5 sm:p-4 rounded-xl border border-emerald-200 shadow-sm">
              <span className="block text-2xl sm:text-3xl font-black text-emerald-600">
                {leaves.length}
              </span>
              <span className="text-xs font-bold text-slate-700 mt-1 block">Surat Izin Keluar</span>
              <span className="text-[11px] text-emerald-700 font-medium">Keluar / Pulang</span>
            </div>
            <div className="bg-rose-50/80 p-3.5 sm:p-4 rounded-xl border border-rose-200 shadow-sm">
              <span className="block text-2xl sm:text-3xl font-black text-rose-600">
                {medicalRecords.length}
              </span>
              <span className="text-xs font-bold text-slate-700 mt-1 block">Rekam Medis UKS</span>
              <span className="text-[11px] text-rose-700 font-medium">Kesehatan Murid</span>
            </div>
          </div>
